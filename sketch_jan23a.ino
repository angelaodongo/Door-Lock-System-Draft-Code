#include <EEPROM.h>     // We are going to read and write Tag's UIDs from/to EEPROM (might not be applicable)
#include <MFRC522.h>
...
constexpr uint8_t greenLed = 7;  //for the LED lights pin
constexpr uint8_t blueLed = 6;   //for the LED lights pin
constexpr uint8_t redLed = 5;   //for the LED lights pin
constexpr uint8_t ServoPin = 8;   //for the servo motor pin
constexpr uint8_t BuzzerPin = 4;   //for the buzzer pin
